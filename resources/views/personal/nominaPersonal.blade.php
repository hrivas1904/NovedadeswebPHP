                                    ...
                                    <div class="empleado-box p-3">
                                        ...
                                        <div class="row g-2 mb-2">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                ...
                                                <input name="numero_cuenta" type="number" id="inputNumeroCuenta" class="form-control" />
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <label class="form-label">CBU</label>
                                                <input name="cbu" type="number" id="inputCbu" class="form-control" />
                                            </div>                                            
                                        </div>
                                        <button class="btn btn-primary" type="button" id="btnGuardarCuenta">Crear cuenta</button>
                                    </div>
                                </div>
