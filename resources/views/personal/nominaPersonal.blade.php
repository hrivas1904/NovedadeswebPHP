...
@push('modals')
    ...
    <div class="modal fade" id="modalEditEmpleado" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-fullscreen modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content p-2">

                <div class="modal-header">
                    <h5 class="modal-title" id="tituloEdit">
                        <i class="fa-solid fa-user-pen me-2"></i> Editar colaborador
                    </h5>
                ...
                <div class="modal-body">
                    <form id="formEditEmpleado">
                        ...
                        <input type="hidden" name="legajo" id="edit_legajo">
                ...
                <div class="modal-footer">
                    <button class="btn btn-danger" onclick="cerrarEdicionEmpleado()">
                        Cancelar
                    </button>
                    <button type="submit" form="formEditEmpleado" class="btn btn-primary">
                        Guardar cambios
                    </button>
                </div>
