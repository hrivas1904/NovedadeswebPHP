                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <div class="input-group">
                                            <input type="number" id="firstPartCuil" class="form-control text-center" min="00" style="max-width: 70px;" maxlength="2" required>
                                            <span class="input-group-text">-</span>
                                            <input type="text" id="middlePartCuil" class="form-control text-center bg-light" readonly>
                                            <span class="input-group-text">-</span>
