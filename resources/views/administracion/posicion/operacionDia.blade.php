...
<div class="container-fluid">
    ...
    <div class="row mx-1 my-4 p-2 justify-content-between align-items-center"
        style="
            ...
            ">
        <div class="col-auto p-2 d-flex flex-column justify-content-start" style="color: var(--color-default)">
            <label class="fw-bolder mb-1" style="font-size:0.8rem;">POSICIÓN EQUILIBRADA</label>
            <label class="fw-bolder text-muted" style="font-size:0.8rem;">Ingresos hoy - Gastos hoy + Saldos Bancos</label>
        </div>
        <div class="col-auto justify-content-end">
            <label class="fw-bolder h2 mb-2">$0,00</label>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header" style="background-color: var(--color-second); color: white">
            <div class="row d-flex justify-content-between">
                <div class="col-auto">
                    <label class="fw-bolder" style="font-size:0.8rem;">Ingresos presupuestados hoy</label>
                </div>
                <div class="col-auto">
                    <label class="fw-bolder" style="font-size:0.8rem;">$0,00</label>
                </div>
            </div>
        </div>
        <div class="card-body">
    ...
    <div class="card my-4">
        <div class="card-header" style="background-color: var(--color-default); color: white">
            <div class="row d-flex justify-content-between">
                <div class="col-auto">
                    <label class="fw-bolder" style="font-size:0.8rem;">Egresos presupuestados hoy</label>
                </div>
                <div class="col-auto">
                    <label class="fw-bolder" style="font-size:0.8rem;">$0,00</label>
                </div>
