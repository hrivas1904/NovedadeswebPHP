                    ...
                    <div class="empleado-box p-3 mb-4">
                        <div class="row d-flex gap-3">
                            <div class="col-lg-3">
                                ...
                                <input id="inputFechaDesde" name="fechaDesde" class="form-control" type="date" required>
                            </div>
                            <div class="col-lg-3">
                                <label for="fechaHasta" class="form-label">Hasta</label>
                                <input id="inputFechaHasta" name="fechaHasta" class="form-control" type="date" required>
                            </div>
                        </div>
                    </div>
