...
<head>
    ...
    <title>Olvidé mi contraseña | Sistema de Gestión</title>
...
<body>
    ...
    <div class="card-usuario">
        ...
        <form action="{{ route('restaurarPassword') }}" method="POST" onsubmit="showLoader()">
            @csrf
            ...
            <button type="submit" class="btn-crear">RESTAURAR CONTRASEÑA</button>
        </form>
    </div>
