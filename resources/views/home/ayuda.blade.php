...
<div class="p-2">
    <div class="container-fluid">
        <div class="d-flex align-items-start gap-3 my-2">
            <div class="icon-box">
                <img src="{{ asset('img/icons/ayuda-logo.png') }}" style="height: 32px;" alt="Logo mesa de ayuda">
            </div>
            <div>
                <h3 class="tituloVista">MESA DE AYUDA</h3>
                <p class="mb-0 text-muted">Desde aquí podés comunicarte con Recursos Humanos y/o Sistemas para realizar consultas.</p>
            </div>
        </div>

        <div id="publicarTicket" class="row mb-4 card p-2">
            <div class="col-12">
    ...
    <h3 class="tituloVista">Historial de Consultas</h3>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    ...
                    <!-- Contenedor chat -->
                    <div id="chatContainer" class="p-3"
                        style="font-size: 1rem; height: 400px; overflow-y: auto; background:#f5f5f5;">
                    </div>
