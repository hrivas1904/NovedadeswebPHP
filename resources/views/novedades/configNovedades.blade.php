                                ...
                                <div class="empleado-box p-3">
                                    <div class="row g-3">
                                        <div class="col-lg-2 col-12">
                                            <label class="form-label">CÓDIGO</label>
                                            <input type="text" id="inputCodigoEdit" name="codigoEdit"
                                                class="form-control">
                                            <input type="hidden" id="idNovedadEdit" name="idNovedad">
                                        </div>
                                        <div class="col-lg-6 col-12">
                                            <label class="form-label">CONCEPTO</label>
                                            <input type="text" id="inputNovedadEdit" name="novedadEdit"
                                                class="form-control">
                                        </div>
                                        <div class="col-lg-2 col-12">
                                            <label class="form-label">TIPO DE VALOR</label>
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" id="inputCantidadMaxima" name="limiteEdit"
                                                class="form-control">
                                        </div>
